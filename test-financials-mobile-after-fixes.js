...
async function testFinancialsMobileAfterFixes() {
  ...
  console.log('🧪 Testing Financials Mobile Responsiveness (After Fixes)');
  ...
  for (const viewport of viewports) {
    ...
    try {
      ...
      await page.goto('http://localhost:3000/financials', { waitUntil: 'networkidle' });
      ...
      const screenshotPath = `financials-mobile-after-fixes-${viewport.name.toLowerCase().replace(/\s+/g, '-')}.jpg`;
...
testFinancialsMobileAfterFixes().catch(console.error);