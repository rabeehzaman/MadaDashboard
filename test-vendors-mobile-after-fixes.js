...
async function testVendorsMobileAfterFixes() {
  ...
  console.log('🧪 Testing Vendors Mobile Responsiveness (After Fixes)');
  ...
  for (const viewport of viewports) {
    ...
    try {
      ...
      const screenshotPath = `vendors-mobile-after-fixes-${viewport.name.toLowerCase().replace(/\s+/g, '-')}.jpg`;
...
testVendorsMobileAfterFixes().catch(console.error);